...
lab metrics. A public navigation report supplies three scores, their median, and navigation
...
reauthentication; it reports only metrics supported by timespan mode and never invents
